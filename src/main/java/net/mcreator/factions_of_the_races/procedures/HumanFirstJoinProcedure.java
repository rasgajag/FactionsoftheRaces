...
public class HumanFirstJoinProcedure extends FactionsOfTheRacesModElements.ModElement {
	public HumanFirstJoinProcedure(FactionsOfTheRacesModElements instance) {
		super(instance, 8);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				FactionsOfTheRacesMod.LOGGER.warn("Failed to load dependency entity for procedure HumanFirstJoin!");
			return;
		}
