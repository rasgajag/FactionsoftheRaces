...
public class FiveSecProcedure extends FactionsOfTheRacesModElements.ModElement {
	public FiveSecProcedure(FactionsOfTheRacesModElements instance) {
		super(instance, 28);
	}
	...
	public static boolean executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				FactionsOfTheRacesMod.LOGGER.warn("Failed to load dependency entity for procedure FiveSec!");
			return false;
		}
