...
public class ThreeSecProcedure extends FactionsOfTheRacesModElements.ModElement {
	public ThreeSecProcedure(FactionsOfTheRacesModElements instance) {
		super(instance, 26);
	}
	...
	public static boolean executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				FactionsOfTheRacesMod.LOGGER.warn("Failed to load dependency entity for procedure ThreeSec!");
			return false;
		}
