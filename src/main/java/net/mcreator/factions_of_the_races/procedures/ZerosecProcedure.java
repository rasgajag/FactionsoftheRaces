...
public class ZerosecProcedure extends FactionsOfTheRacesModElements.ModElement {
	public ZerosecProcedure(FactionsOfTheRacesModElements instance) {
		super(instance, 23);
	}
	...
	public static boolean executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				FactionsOfTheRacesMod.LOGGER.warn("Failed to load dependency entity for procedure Zerosec!");
			return false;
		}
