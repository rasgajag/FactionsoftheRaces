...
public class FourSecProcedure extends FactionsOfTheRacesModElements.ModElement {
	public FourSecProcedure(FactionsOfTheRacesModElements instance) {
		super(instance, 27);
	}
	...
	public static boolean executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				FactionsOfTheRacesMod.LOGGER.warn("Failed to load dependency entity for procedure FourSec!");
			return false;
		}
