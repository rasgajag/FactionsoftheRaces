...
public class OnesecProcedure extends FactionsOfTheRacesModElements.ModElement {
	public OnesecProcedure(FactionsOfTheRacesModElements instance) {
		super(instance, 24);
	}
	...
	public static boolean executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				FactionsOfTheRacesMod.LOGGER.warn("Failed to load dependency entity for procedure Onesec!");
			return false;
		}
