...
public class TimerpotionluckstartProcedure extends FactionsOfTheRacesModElements.ModElement {
	public TimerpotionluckstartProcedure(FactionsOfTheRacesModElements instance) {
		super(instance, 32);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				FactionsOfTheRacesMod.LOGGER.warn("Failed to load dependency entity for procedure Timerpotionluckstart!");
			return;
		}
