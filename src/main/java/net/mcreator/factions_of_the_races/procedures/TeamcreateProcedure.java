...
public class TeamcreateProcedure extends FactionsOfTheRacesModElements.ModElement {
	public TeamcreateProcedure(FactionsOfTheRacesModElements instance) {
		super(instance, 44);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				FactionsOfTheRacesMod.LOGGER.warn("Failed to load dependency entity for procedure Teamcreate!");
			return;
		}
