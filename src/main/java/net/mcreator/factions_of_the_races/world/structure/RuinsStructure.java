...
package net.mcreator.factions_of_the_races.world.structure;
...
public class RuinsStructure extends FactionsOfTheRacesModElements.ModElement {
	private static Feature<NoFeatureConfig> feature = null;
	private static ConfiguredFeature<?, ?> configuredFeature = null;
	public RuinsStructure(FactionsOfTheRacesModElements instance) {
		super(instance, 40);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 10000) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("factions_of_the_races", "ruins"));
							if (template == null)
								return false;
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("factions_of_the_races:ruins"), configuredFeature);
		}
	}
	@SubscribeEvent
